...
$aid = $_SESSION['aid'];
$result = mysqli_query($al, "SELECT * FROM admin WHERE aid='$aid'");
$admin = mysqli_fetch_assoc($result);

$name = $admin['name'];
$pass = $admin['password']; // stored hashed password (SHA1)
...
<head>
<meta charset="UTF-8">
<title>VMS | Admin Change Password</title>
...
<div class="container">
    ...
    <a href="ahome.php" class="link-home">🏠 Back to Admin Home</a>
</div>
